...
biodata_pembeli = identitas_pembeli("Maritza Adisty Rahim", "085781919676", "Mahasiswa")
...
identifikasi_kendaraan = jenis_mobil("toyota", 10)
...
print (nama , "telah membeli tipe bbm" , bbm , "seharga" , pertameks , "dengan total belanja" , total belanja , "rupiah")
