# -*- coding: utf-8 -*-
"""
Created on Sat Oct  8 13:29:28 2022
...
def identitas_pembeli(nama, nomerHape, pekerjaan):
   return (nama, nomerHape, pekerjaan)

biodata_pembeli = identitas_pembeli("Aisyah Ahnaf Ardhini", "087885370170", "Mahasiswa")
...
bbm = tipe_bbm[1]
print (nama, "telah membeli bbm", bbm, "seharga", pertameks, "dengan total belanja", total_belanja, "rupiah")
