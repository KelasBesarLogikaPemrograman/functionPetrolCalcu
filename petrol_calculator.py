...
biodata_pembeli = identitas_pembeli("Putri", "0812345678", "direktur pertamina")
...
identifikasi_kendaraan = jenis_mobil("rubicon", 3)
...
# print dengan contoh output Putri telah membeli tipe bbm selar seharga  12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli [0]
bbm = "pertameks"

print (f"Putri telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
