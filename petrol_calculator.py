...
biodata_pembeli = identitas_pembeli("Alvredo", "083804645615", "MARKETING COMUNICATION")
...
identifikasi_kendaraan = jenis_mobil("Ferrary", 3)
...
# print dengan contoh output Alvredo telah membeli tipe bbm selar seharga  12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli [0]
bbm = "pertameks"

print (f"Alvredo telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
