...
biodata_pembeli = identitas_pembeli("Ujang", "087816035623", "mahasiswa")
...
identifikasi_kendaraan = jenis_mobil("Yamahmud", 9)
...
# print dengan contoh output maman telah membeli tipe bbm selar seharga 12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli[0]
bbm = "selar"

print(f"maman telah membeli tipe bbm {bbm} seharga 5000 dengan total {total_belanja}")
