...
biodata_pembeli = identitas_pembeli("rizky", "0821232123", "ceo")
...
identifikasi_kendaraan = jenis_mobil("nismo", 3)
...
print (f"rizky telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
