...
biodata_pembeli = identitas_pembeli("Dicky", "0812345678", "ceo bank")
...
identifikasi_kendaraan = jenis_mobil("hyundai", 3)
...
# print dengan contoh output Dicky  telah membeli tipe bbm selar seharga  12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli [0]
bbm = "pertameks"

print (f"Dicky telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
