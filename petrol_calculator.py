...
biodata_pembeli = identitas_pembeli("steve", "0842000", "doctor")
...
#masukkan data bbm
tipe_bbm = jenis_bbm(("pertalet", "pertamak", "soler"))
...
identifikasi_kendaraan = jenis_mobil("nissan", 3)
...
print(f"steve telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
