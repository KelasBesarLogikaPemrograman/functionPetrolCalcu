...
biodata_pembeli = identitas_pembeli("Rafi", "082122550349", "Mahasiswa")
...
#masukkan data bbm
tipe_bbm =jenis_bbm[("pertalait", "pertamek", "selar")]
...
total_belanja = hitung_biaya_bbm(identifikasi_kendaraan[1], pertamek)
