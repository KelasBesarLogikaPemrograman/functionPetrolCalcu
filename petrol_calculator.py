...
biodata_pembeli = identitas_pembeli("bambang", "081398522184", "karyawan swasta")
...
identifikasi_kendaraan = jenis_mobil("toyota", 30)
...
total_belanja = hitung_biaya_bbm(identifikasi_kendaraan[1], selar)

print(total_belanja, "a")

# print dengan contoh output bambang telah membeli tipe bbm selar seharga 12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli[0]
bbm = "selar"

print(f"bambang telah membeli tipe bbm {bbm} seharga 5000 dengan total {total_belanja}")
