...
biodata_pembeli = identitas_pembeli("ryujin", "081234567890", "barista")
...
# print dengan contoh output ryujin  telah membeli tipe bbm selar seharga  12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli [0]
bbm = "selar"
print (f"ryujin telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
