...
biodata_pembeli = identitas_pembeli("Shafa", "0895329911050", "manajer perusahaan")
...
identifikasi_kendaraan = jenis_mobil("toyota", 3)
...
# print dengan contoh output Shafa  telah membeli tipe bbm selar seharga  12000 dengan total belanja 360000 rupiah
nama = biodata_pembeli [0]
bbm = "pertameks"

print (f"Shafa telah membeli tipe bbm {bbm} seharga 12000 dengan total {total_belanja}")
